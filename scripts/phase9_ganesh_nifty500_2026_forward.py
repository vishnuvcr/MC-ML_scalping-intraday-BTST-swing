...
VAL_END=pd.Timestamp("2026-02-28 23:59")
TEST1_START=pd.Timestamp("2026-03-01")
...
def main():
    ...
    ap.add_argument("--old-root",required=False,default=""); ap.add_argument("--new-root",required=True)
